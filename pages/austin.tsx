...
const groups : Record<string, group> = {
  ...
  MORNING_JOES: {
    ...
    runs: [
      {
        name: "Morning Jo's",
        description: "An inviting free run group open to all runners, they run 3-6 miles at verious paces.",
  ...
  A_SHIP_OF_FOOLS: {
    ...
    description: "Before joining the group, make sure to sign their waiver. It can be found on their website.",
    social: {
    ...
    runs: [
      {
        ...
        description: "The pace can be brisk.  It’s dark.  Be prepared for 7 – 10 miles at around 8:30 per mile.",
      ...
      },
      {
        ...
        description: "Long run ranging from 4-20 miles. The parking lot typically fills up by 6:45 am so plan accordingly.",
  ...
  AUSTIN_INFORMAL_RUNNING_CLUB: {
    ...
    social: {
      website: "https://www.meetup.com/Austin-Informal-Running-Club-Home-of-TMIRCE-ATX/"
    },
    runs: [
      {
        name: 'Austin Informal Running Club',
    ...
    runs: [
      {
        ...
        description: '3, 5, 7 mile loops on loops on loops. All paces welcome as always!',
    ...
    runs: [
      {
        ...
        description: 'These workouts range from 400s on the track, to hills, mile repeats, and other hard efforts.',
  ...
  EAST_SIDE_BEER_RUNNERS: {
    ...
    runs: [
      {
        name: "East Side Beer Runners",
        description: "Different workouts every week, take whatever pace you want.",
